...
def port_has_tap(request, port_id):
    return NetworkClient(request).taps.port_has_tap(port_id)
...
def create_tap(request, port_id):
    return NetworkClient(request).taps.create_tap(port_id)

def delete_tap(request, port_id):
    return NetworkClient(request).taps.delete_tap(port_id)
