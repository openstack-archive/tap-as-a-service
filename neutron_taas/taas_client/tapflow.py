...
class TapFlowList(extension.ClientExtensionList, TapFlow):
    """List tap flows."""
...
class TapFlowCreate(extension.ClientExtensionCreate, TapFlow):
    """Create a tap flow."""
...
class TapFlowDelete(extension.ClientExtensionDelete, TapFlow):
    """Delete a tap flow."""

    shell_command = 'tap-flow-delete'


class TapFlowShow(extension.ClientExtensionShow, TapFlow):
    """Show a tap flow."""
