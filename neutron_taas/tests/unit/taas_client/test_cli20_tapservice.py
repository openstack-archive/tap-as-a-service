...
from neutron_taas.tests.unit.taas_client import test_cli20


class CLITestV20TapServiceJSON(test_cli20.CLITestV20Base, tapservice.TapService):
    ...
    def test_create_tap_service_mandatory_params(self,port_id="random_port",network_id="random_net"):
