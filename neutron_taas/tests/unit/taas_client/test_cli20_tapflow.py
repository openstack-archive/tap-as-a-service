...
class CLITestV20TapFlowJSON(test_cli20.CLITestV20Base,
    ...
    def _test_create_tap_flow(self, port_id="random_port",
                              ...
                              pos_name_attr=None, pos_val_attr=None,
                              name=''):
        # Common definition for creating Tap flow
        arg_attr = arg_attr or []
        pos_name_attr = pos_name_attr or []
        pos_val_attr = pos_val_attr or []
        ...
        position_names = ['port', 'service_id', 'direction'] + pos_name_attr
        position_values = [port_id, service_id, direction] + pos_val_attr
    ...
    def test_create_tap_flow_all_params(self):
        ...
        self._test_create_tap_flow(name=name,
                                   arg_attr=['--name', '--description'],
                                   pos_name_attr=['name', 'description'],
                                   pos_val_attr=[name, description])
