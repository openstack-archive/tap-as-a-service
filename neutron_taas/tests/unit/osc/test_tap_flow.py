...
class TestListTapFlow(fakes.TestNeutronClientOSCV2):
    ...
    def setUp(self):
        ...
        self.cmd = tap_flow.ListTapFlow(self.app, self.namespace)
...
class TestCreateTapFlow(fakes.TestNeutronClientOSCV2):
    ...
    def setUp(self):
        ...
        # Get the command object to test
        self.cmd = tap_flow.CreateTapFlow(self.app,
                                               self.namespace)
...
class TestDeleteTapFlow(fakes.TestNeutronClientOSCV2):
    ...
    def setUp(self):
        ...
        self.cmd = tap_flow.DeleteTapFlow(self.app,
                                               self.namespace)
...
class TestShowTapFlow(fakes.TestNeutronClientOSCV2):
    ...
    def setUp(self):
        ...
        # Get the command object to test
        self.cmd = tap_flow.ShowTapFlow(self.app, self.namespace)
...
class TestUpdateTapFlow(fakes.TestNeutronClientOSCV2):
    ...
    def setUp(self):
        ...
        self.cmd = tap_flow.UpdateTapFlow(self.app,
                                               self.namespace)
