...
class TestListTapService(fakes.TestNeutronClientOSCV2):
    ...
    def setUp(self):
        ...
        self.cmd = tap_service.ListTapService(self.app, self.namespace)
...
class TestCreateTapService(fakes.TestNeutronClientOSCV2):
    ...
    def setUp(self):
        ...
        # Get the command object to test
        self.cmd = tap_service.CreateTapService(self.app,
                                                     self.namespace)
...
class TestDeleteTapService(fakes.TestNeutronClientOSCV2):
    ...
    def setUp(self):
        ...
        self.cmd = tap_service.DeleteTapService(self.app,
                                                     self.namespace)
...
class TestShowTapService(fakes.TestNeutronClientOSCV2):
    ...
    def setUp(self):
        ...
        # Get the command object to test
        self.cmd = tap_service.ShowTapService(self.app, self.namespace)
...
class TestUpdateTapService(fakes.TestNeutronClientOSCV2):
    ...
    def setUp(self):
        ...
        self.cmd = tap_service.UpdateTapService(self.app,
                                                self.namespace)
