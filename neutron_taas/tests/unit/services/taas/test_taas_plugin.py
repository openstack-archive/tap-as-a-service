...
class TestTaasPlugin(testlib_api.SqlTestCase):
    ...
    def test_verify_taas_id_reused(self):
        # make small range id
        old_vlan_range_start = cfg.CONF.taas.vlan_range_start
        old_vlan_range_end = cfg.CONF.taas.vlan_range_end
        cfg.CONF.taas.vlan_range_start = 1
        cfg.CONF.taas.vlan_range_end = 3
        with self.tap_service() as ts_1, self.tap_service() as ts_2, \
            self.tap_service() as ts_3:
            ts_id_1 = ts_1['id']
            ts_id_2 = ts_2['id']
            ts_id_3 = ts_3['id']
            ...
            # free an tap_id and verify could reallocate same tap id
            ...
            self.assertEqual(set([1, 2]), set([tap_id_assoc_3['taas_id'],
                             tap_id_assoc_2['taas_id']]))
        cfg.CONF.taas.vlan_range_start = old_vlan_range_start
        cfg.CONF.taas.vlan_range_end = old_vlan_range_end
