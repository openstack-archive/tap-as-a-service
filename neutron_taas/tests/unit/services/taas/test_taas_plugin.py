...
class TestTaasPlugin(testlib_api.SqlTestCase):
    ...
    def tap_service(self):
        ...
        self.driver.assert_has_calls([
            mock.call.create_tap_service(self._context, req),
            mock.call.create_tap_service_precommit(
                self._context, self._tap_service),
            mock.call.create_tap_service_postcommit(
                self._context, self._tap_service),
        ])
    ...
    def tap_flow(self, tap_service, tenant_id=None):
        ...
        self.driver.assert_has_calls([
            mock.call.create_tap_flow(self._context, req),
            mock.call.create_tap_flow_precommit(self._context,
                                                self._tap_flow),
            mock.call.create_tap_flow_postcommit(self._context,
                                                 self._tap_flow),
        ])
    ...
    def test_delete_tap_service(self):
        ...
        self.driver.assert_has_calls([
            mock.call.delete_tap_service(self._context, ts['id']),
            mock.call.delete_tap_service_precommit(self._context, ts['id']),
            mock.call.delete_tap_service_postcommit(self._context, ts['id']),
        ])
    ...
    def test_delete_tap_service_with_flow(self):
        with self.tap_service() as ts, \
            ...
            self._plugin.delete_tap_service(self._context, ts['id'])
        self.driver.assert_has_calls([
            mock.call.delete_tap_flow(self._context, tf['id']),
            mock.call.delete_tap_flow_precommit(self._context, tf['id']),
            mock.call.delete_tap_flow_postcommit(self._context, tf['id']),
            mock.call.delete_tap_service(self._context, ts['id']),
            mock.call.delete_tap_service_precommit(self._context, ts['id']),
            mock.call.delete_tap_service_postcommit(self._context, ts['id']),
        ])
    ...
    def test_delete_tap_flow_failed_on_service_driver(self):
        with self.tap_service() as ts:
            with self.tap_flow(tap_service=ts['id']) as tf:
