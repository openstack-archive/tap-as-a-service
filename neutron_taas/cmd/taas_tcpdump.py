...
OPTS = [
    cfg.StrOpt('port', help='Neutron Port ID to tap'),
]
...
def main():
    ...
    try:
        ...
        LOG.info("interface_name: %s", interface_name)
        have_vif = True
        ...
        LOG.info("tap_service: %s", tap_service)
